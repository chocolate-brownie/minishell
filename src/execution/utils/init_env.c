...
/*   Updated: 2025/04/30 08:57:41 by shasinan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_env_all(t_env *env, char *id, char *value, char *raw)
{
	free_env(env);
	free(id);
	free(value);
...
t_env	*new_node_with_elem(char **envp, int i, int j, t_env *head)
{
	char	*id;
	char	*value;
	char	*raw;
